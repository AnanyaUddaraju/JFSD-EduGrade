...
<%@ include file="adminnav.jsp" %>
    ...
    <div class="content">
        <div class="card">
            ...
            <form method="post" action="insertfaculty" enctype="multipart/form-data">
                <table>
                    <tr>
                        <td><b>ID</b></td>
                        <td>
...
<option value="MECHANICAL">MECHANICAL</option>
      ...
      <td>
        ...
        <option value="">--Select--</option>
        <option value="1">MFC  -- 20MF2101</option>
        <option value="2">MFE  --21MF2102</option>
        <option value="3">JFSD --21CS2101</option>
        <option value="4">PFSD -- 21CS2102</option>
        <option value="5">ENG --21EN2101</option>  
        </select>
      </td>
    </tr>
    
           <tr>
      <td><label>Select Section</label></td>
      <td>
